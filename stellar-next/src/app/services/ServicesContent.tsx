          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            {services.map((service, index) => (
              <motion.div
                ...
                className="group flex flex-col md:flex-row gap-10 items-start p-10 border border-white/5 hover:border-[#2E3192]/30 bg-black/10 hover:bg-black/30 transition-all duration-700 shadow-xl"
              >
                <div className="w-16 h-16 rounded-sm border border-white/5 flex items-center justify-center text-[#2E3192] group-hover:bg-[#2E3192] group-hover:text-white transition-all duration-700 shrink-0">
