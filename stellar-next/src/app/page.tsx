...
export default function Home() {
  return (
    <main className="w-full bg-[#1A1A1A] text-white overflow-hidden">
      ...
      <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute bottom-0 left-0 right-0 h-64 bg-gradient-to-t from-[#1A1A1A] to-transparent z-10" />
        </div>
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 md:px-12 w-full flex flex-col items-center text-center mt-32">
          ...
          >
            <h1 className="font-display text-4xl md:text-[7rem] font-bold leading-[1.1] md:leading-[0.95] tracking-tighter mb-10 md:mb-12">
            ...
            <p className="text-base md:text-xl text-[#C7C7C7]/60 font-light max-w-2xl mx-auto mb-14 md:mb-16 leading-relaxed tracking-wide">
            ...
            <div className="flex flex-col sm:flex-row gap-8 justify-center">
              ...
              <Link href="/products" className="group px-12 py-6 border border-white/40 text-white font-display tracking-[0.22em] uppercase text-[10px] font-bold hover:bg-white hover:text-[#1A1A1A] transition-all duration-500 flex items-center justify-center hover:border-white">
                Explore Collection
              </Link>
            </div>
          </motion.div>
      ...
      {/* 2. Trust Indicators */}
      <section className="relative z-30 border-y border-white/5 bg-[#1A1A1A]">
        <div className="max-w-7xl mx-auto px-6 md:px-12 py-12 md:py-20">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-8">
            {[
              ...
              >
                <div className="w-10 h-10 md:w-12 md:h-12 rounded-full border border-white/5 flex items-center justify-center mb-4 md:mb-6 group-hover:border-[#2E3192]/50 transition-colors duration-500">
                  <stat.icon size={18} className="text-[#2E3192] opacity-80" />
                </div>
                <span className="font-display text-2xl md:text-4xl font-bold mb-1 md:mb-2 tracking-tighter">{stat.value}</span>
                <span className="text-[8px] md:text-[10px] uppercase tracking-[0.2em] md:tracking-[0.3em] text-[#C7C7C7]/50 font-bold">{stat.label}</span>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            >
              ...
              <Link href="/about" className="inline-flex items-center gap-4 mt-16 text-xs font-display uppercase tracking-[0.3em] font-bold hover:text-[#2E3192] transition-colors group">
                Discover Our Story
                <div className="w-10 h-[1px] bg-white/20 group-hover:w-16 group-hover:bg-[#2E3192] transition-all duration-500" />
              </Link>
            </motion.div>
          </div>
        </div>
      ...
      {/* 4. Product Showcase */}
      <section className="py-48 bg-black/40 border-y border-white/5">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center mb-24">
            <span className="text-[#2E3192] font-display tracking-[0.4em] uppercase text-xs font-bold mb-6 block">The Collection</span>
            <h2 className="font-display text-4xl md:text-7xl font-bold mb-8">Elevated Craftsmanship</h2>
            <p className="text-[#C7C7C7]/60 font-light max-w-2xl mx-auto">Selected categories of villa elevators and passenger lifts engineered for South India&apos;s most demanding architectural spaces.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {products.map((product, index) => (
              <motion.div
                ...
                className="group relative aspect-[16/10] overflow-hidden bg-[#1A1A1A] cursor-pointer shadow-2xl"
              >
                <Image 
                  src={product.image} 
                  alt={`${product.title} Installation - Stellar Elevators`} 
                  fill
                  className="object-cover opacity-50 group-hover:opacity-30 group-hover:scale-105 transition-all duration-1000"
                />
          ...
          <div className="mt-24 text-center">
            <Link href="/products" className="inline-flex items-center gap-6 px-12 py-6 border border-white/10 text-xs font-display uppercase tracking-[0.4em] font-bold hover:bg-white hover:text-black transition-all duration-500">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            >
              ...
              <p className="text-[#C7C7C7] font-light text-xl leading-relaxed mb-16">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-12">
                {reasons.map((reason, index) => (
                  ...
                  >
                    ...
                    <div>
                      <h4 className="font-display font-bold text-lg mb-2">{reason.title}</h4>
      ...
      <section className="relative py-64 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12">
          ...
          >
            ...
            <h2 className="font-display text-5xl md:text-8xl font-bold mb-10 leading-[1]">
              Precision Forged in <br /> Hyderabad
            </h2>
            <p className="text-xl text-[#C7C7C7]/80 font-light mb-16 leading-relaxed max-w-2xl">
            ...
            <div className="flex flex-wrap gap-x-12 gap-y-6 mb-16">
              {[
                ...
                <div key={i} className="flex items-center gap-3">
                  ...
                  <span className="text-xs font-display uppercase tracking-widest font-bold">{item}</span>
                </div>
              ))}
            </div>
            
            <Link href="/about" className="group inline-flex items-center gap-6 text-xs font-display uppercase tracking-[0.4em] font-bold">
              <span className="w-16 h-[1px] bg-white/20 group-hover:w-24 group-hover:bg-[#2E3192] transition-all duration-500" />
              Explore Facility
            </Link>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="flex flex-col md:flex-row justify-between items-end mb-24 gap-8">
            ...
            >
              ...
              <h2 className="font-display text-4xl md:text-7xl font-bold">Landmarks in Motion</h2>
            </motion.div>
            <Link href="/projects" className="text-xs font-display uppercase tracking-[0.4em] font-bold hover:text-[#2E3192] transition-colors flex items-center gap-3 group shrink-0 pb-2 border-b border-white/10 hover:border-[#2E3192]">
            ...
            {projects.map((project, index) => (
              ...
              >
                ...
                <div className="flex justify-between items-end">
                  <div>
                    <h3 className="font-display text-2xl font-bold mb-2 group-hover:text-[#2E3192] transition-colors">{project.title}</h3>
                    <div className="flex items-center gap-2 text-[#C7C7C7]/60 text-sm font-light">
                      <MapPin size={14} className="text-[#2E3192]" />
                      {project.location}
                    </div>
                  </div>
                  <ChevronRight size={24} className="text-[#C7C7C7]/20 group-hover:text-[#2E3192] group-hover:translate-x-2 transition-all duration-500" />
                </div>
              </motion.div>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            >
              ...
              <h2 className="font-display text-4xl md:text-7xl font-bold mb-10 leading-[1.1]">Smart Vertical <br /> Intelligence</h2>
              <p className="text-[#C7C7C7] font-light text-xl leading-relaxed mb-16">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-12">
                {[
                  ...
                  <div key={i} className="group">
                    <div className="w-12 h-12 rounded-sm border border-white/5 flex items-center justify-center mb-6 group-hover:border-[#2E3192]/50 transition-colors">
                      <tech.icon size={20} className="text-[#2E3192]" />
                    </div>
                    <h4 className="font-display font-bold text-lg mb-2">{tech.title}</h4>
                    <p className="text-sm text-[#C7C7C7]/50 font-light leading-relaxed">{tech.desc}</p>
                  </div>
                ))}
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="absolute inset-0 border border-white/5 rounded-full scale-110 animate-[spin_30s_linear_infinite]" />
      ...
      <section className="py-24 md:py-48 bg-[#1A1A1A]">
        <div className="max-w-7xl mx-auto px-6 md:px-12 text-center">
          ...
          >
            ...
            <h2 className="font-display text-4xl md:text-7xl font-bold mb-8">Serving South India</h2>
            <p className="text-[#C7C7C7]/60 font-light max-w-2xl mx-auto">Providing immediate service response for luxury elevators across key urban corridors.</p>
          </motion.div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12">
            {['Hyderabad', 'Bengaluru', 'Chennai', 'Vijayawada'].map((city, i) => (
              <motion.div 
                ...
                className="group"
              >
                <h4 className="font-display text-2xl font-bold mb-4 group-hover:text-[#2E3192] transition-colors">{city}</h4>
                <div className="w-8 h-[1px] bg-white/10 mx-auto group-hover:w-16 group-hover:bg-[#2E3192] transition-all duration-500" />
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="relative py-64 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          <motion.div
            ...
            transition={{ duration: 1 }}
          >
            <h2 className="font-display text-5xl md:text-[7rem] font-bold mb-10 leading-[0.95] tracking-tighter">Let&apos;s Elevate <br /> Your Building</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-8 justify-center items-center">
              <Link href="/contact" className="inline-flex items-center justify-center px-16 py-8 bg-white text-[#1A1A1A] font-display tracking-[0.22em] uppercase text-[10px] font-bold hover:bg-[#C7C7C7] transition-all duration-500 shadow-2xl">
                Request Site Survey
              </Link>
