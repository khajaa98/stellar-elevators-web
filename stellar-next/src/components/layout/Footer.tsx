...
export default function Footer() {
  return (
    <footer className="bg-black text-[#C7C7C7] border-t border-white/5 pt-24 pb-12 md:pt-32 md:pb-16">
      <div className="max-w-[1400px] mx-auto px-8 md:px-12 grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-24">
        ...
        <div className="space-y-10">
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <span className="font-display font-bold text-xl tracking-[0.15em] uppercase text-white">
              Stellar<span className="text-[#C7C7C7] font-light">Elevators</span>
            </span>
          </Link>
          <p className="text-sm md:text-base leading-relaxed font-light text-[#C7C7C7]/50 max-w-sm">
        ...
        {/* Quick Links */}
        <div className="space-y-10">
          <h4 className="text-white font-display font-bold tracking-[0.18em] uppercase text-[10px]">Navigation</h4>
        ...
        {/* Contact Info */}
        <div className="space-y-10">
          <h4 className="text-white font-display font-bold tracking-[0.18em] uppercase text-[10px]">Inquiries</h4>
          <ul className="space-y-6 text-sm font-light">
            <li className="flex items-start gap-4">
              <MapPin size={16} className="text-[#2E3192] shrink-0 mt-1" />
              <span className="leading-relaxed text-[#C7C7C7]/60">Plot no-15, Suchitra, Hyderabad,<br />Telangana 500067</span>
            </li>
            <li className="flex items-center gap-4">
              <Phone size={16} className="text-[#2E3192] shrink-0" />
              <a href="tel:+919490944220" className="hover:text-white transition-colors text-[#C7C7C7]/60">+91 94909 44220</a>
            </li>
            <li className="flex items-center gap-4">
              <Mail size={16} className="text-[#2E3192] shrink-0" />
              <a href="mailto:info@stellarelevators.com" className="hover:text-white transition-colors text-[#C7C7C7]/60">info@stellarelevators.com</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      {/* Bottom Bar */}
      <div className="max-w-[1400px] mx-auto px-8 md:px-12 mt-32 pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8 text-[10px] tracking-[0.2em] font-bold uppercase text-[#C7C7C7]/30">
